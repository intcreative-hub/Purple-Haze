      ...
      <div className="p-6 flex flex-col space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="testimonial-meta flex-grow">
            ...
            <p className="testimonial-date text-xs text-neutral-600">
              {testimonial.date}
            </p>
          </div>
        ...
        {/* Optional: Product Mentioned */}
        {testimonial.product && (
          <div className="testimonial-product pt-2 border-t border-primary-emerald/10">
