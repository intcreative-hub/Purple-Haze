        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#products" className="text-light-text/60 transition-colors hover:text-emerald">
                  Products
                </a>
              </li>
              <li>
                <a href="#about" className="text-light-text/60 transition-colors hover:text-emerald">
                  About Us
                </a>
              </li>
              <li>
                <a href="#hours" className="text-light-text/60 transition-colors hover:text-emerald">
                  Hours & Location
                </a>
              </li>
              <li>
                <a href="#contact" className="text-light-text/60 transition-colors hover:text-emerald">
                  Contact
                </a>
              </li>
            </ul>
